...
class TeamMember(BaseModel):
    firstName: str = Field(..., description="First name of the team member", json_schema_extra={"X-FieldPrompt": "Look for the first name of the team member"})
    lastName: str = Field(..., description="Last name of the team member", json_schema_extra={"X-FieldPrompt": "Look for the last name of the team member"})
    title: str = Field(..., description="Title, position of the team member", json_schema_extra={"X-FieldPrompt": "Look for the title or position of the team member"})
    pastExperiences: str = Field(
        ..., description="Previous experiences", json_schema_extra={"X-FieldPrompt": "Look for previous experiences of the team member: jobs, education, companies"}
    )


class Deck(BaseModel):
    model_config = ConfigDict(json_schema_extra={"X-SystemPrompt": system_prompt})
    name: str = Field(..., description="Name of the company", json_schema_extra={"X-FieldPrompt": "Look for the name of the company"})
    website: str = Field(
        ...,
    ...
    country: str = Field(..., description="2 letter Country code of the company ", json_schema_extra={"X-FieldPrompt": "Look for the companys HQ location, in 2 letter format"})
