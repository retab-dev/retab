...
namespace Retab
{
    ...
    public class WorkflowStepsService : Service
    {
        ...
        public virtual async Task<RetabList<WorkflowRunStep>> ListAsync(string httpBearer, WorkflowStepsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<WorkflowRunStep>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<WorkflowRunStep>> List(string httpBearer, WorkflowStepsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<WorkflowRunStep>("/v1/workflows/steps", options, requestOptions, cancellationToken);
        }
