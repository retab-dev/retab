namespace Retab
{
    ...
    public class WorkflowBlockExecutionsService : Service
    {
        ...
        public virtual async Task<PaginatedList<StoredBlockExecution>> ListAsync(WorkflowBlockExecutionsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            return await this.FetchPageAsync<StoredBlockExecution>("/v1/workflows/blocks/executions", options, null, requestOptions, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<PaginatedList<StoredBlockExecution>> List(WorkflowBlockExecutionsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<StoredBlockExecution> CreateAsync(WorkflowBlockExecutionsCreateOptions options, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            return await this.PostAsync<StoredBlockExecution>("/v1/workflows/blocks/executions", options, requestOptions, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="CreateAsync"/>.</summary>
        public virtual Task<StoredBlockExecution> Create(WorkflowBlockExecutionsCreateOptions options, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
