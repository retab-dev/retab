...
namespace Retab
{
    ...
    public class ParsesService : Service
    {
        ...
        public virtual async Task<RetabList<Parse>> ListAsync(string httpBearer, ParsesListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<Parse>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<Parse>> List(string httpBearer, ParsesListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<Parse>("/v1/parses", options, requestOptions, cancellationToken);
        }
