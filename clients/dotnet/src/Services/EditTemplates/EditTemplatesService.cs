...
namespace Retab
{
    ...
    public class EditTemplatesService : Service
    {
        ...
        public virtual async Task<RetabList<EditTemplate>> ListAsync(string httpBearer, EditTemplatesListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<EditTemplate>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<EditTemplate>> List(string httpBearer, EditTemplatesListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<EditTemplate>("/v1/edits/templates", options, requestOptions, cancellationToken);
        }
