...
namespace Retab
{
    ...
    public class ExperimentRunsService : Service
    {
        ...
        public virtual async Task<RetabList<ExperimentRun>> ListAsync(string httpBearer, ExperimentRunsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<ExperimentRun>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<ExperimentRun>> List(string httpBearer, ExperimentRunsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<ExperimentRun>("/v1/workflows/experiments/runs", options, requestOptions, cancellationToken);
        }
