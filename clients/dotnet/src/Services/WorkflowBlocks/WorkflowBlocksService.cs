...
namespace Retab
{
    ...
    public class WorkflowBlocksService : Service
    {
        ...
        public virtual async Task<RetabList<WorkflowBlock>> ListAsync(string httpBearer, WorkflowBlocksListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<WorkflowBlock>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<WorkflowBlock>> List(string httpBearer, WorkflowBlocksListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<WorkflowBlock>("/v1/workflows/blocks", options, requestOptions, cancellationToken);
        }
