...
namespace Retab
{
    ...
    public class WorkflowReviewsService : Service
    {
        ...
        public virtual async Task<RetabList<Review>> ListAsync(string httpBearer, WorkflowReviewsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<Review>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<Review>> List(string httpBearer, WorkflowReviewsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<Review>("/v1/workflows/reviews", options, requestOptions, cancellationToken);
        }
