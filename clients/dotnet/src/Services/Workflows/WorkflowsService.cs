namespace Retab
{
    ...
    public class WorkflowsService : Service
    {
        ...
        public virtual async Task<PaginatedList<Workflow>> ListAsync(string httpBearer, WorkflowsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            return await this.FetchPageAsync<Workflow>("/v1/workflows", options, httpBearer, requestOptions, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<PaginatedList<Workflow>> List(string httpBearer, WorkflowsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
