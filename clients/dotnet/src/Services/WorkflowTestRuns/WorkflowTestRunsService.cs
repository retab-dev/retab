...
namespace Retab
{
    ...
    public class WorkflowTestRunsService : Service
    {
        ...
        public virtual async Task<RetabList<WorkflowTestRun>> ListAsync(string httpBearer, WorkflowTestRunsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            ...
            return await this.Client.MakeAPIRequest<RetabList<WorkflowTestRun>>(request, cancellationToken);
        }

        /// <summary>Compatibility wrapper for <see cref="ListAsync"/>.</summary>
        public virtual Task<RetabList<WorkflowTestRun>> List(string httpBearer, WorkflowTestRunsListOptions? options = null, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
        ...
        {
            return this.ListAutoPagingAsync<WorkflowTestRun>("/v1/workflows/tests/runs", options, requestOptions, cancellationToken);
        }
        ...
        public virtual async Task<WorkflowTestRun> CreateAsync(string httpBearer, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
            var request = new RetabRequest
            {
        ...
        public virtual Task<WorkflowTestRun> Create(string httpBearer, RequestOptions? requestOptions = null, CancellationToken cancellationToken = default)
        {
