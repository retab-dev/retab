namespace Retab
{
    ...
    /// <summary>Represents declarative plan resource change type values.</summary>
    ...
    public enum DeclarativePlanResourceChangeType
    {
        ...
        MergeDicts,
        [EnumMember(Value = "while_loop_sentinel_start")]
        WhileLoopSentinelStart,
        [EnumMember(Value = "while_loop_sentinel_end")]
        WhileLoopSentinelEnd,
        [EnumMember(Value = "for_each_sentinel_start")]
        ForEachSentinelStart,
        [EnumMember(Value = "for_each_sentinel_end")]
        ForEachSentinelEnd,
    }
}
