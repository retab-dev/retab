namespace Retab
{
    ...
    /// </summary>
    public class ManualWorkflowTestSourceDiscriminatorConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public override object? ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object? existingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                case "manual": return jObject.ToObject<ManualWorkflowTestSource>(serializer);
                case "run_step": return jObject.ToObject<RunStepWorkflowTestSource>(serializer);
