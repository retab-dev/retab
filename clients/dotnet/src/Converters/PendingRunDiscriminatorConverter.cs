namespace Retab
{
    ...
    /// </summary>
    public class PendingRunDiscriminatorConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public override object? ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object? existingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                case "awaiting_review": return jObject.ToObject<AwaitingReviewRun>(serializer);
                ...
                case "error": return jObject.ToObject<ErrorTerminal>(serializer);
