    ...
    public class ExistConditionDiscriminatorConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        public override object? ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, object? existingValue, Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            switch (discriminatorValue)
            {
                ...
                case "contains": return jObject.ToObject<ContainsCondition>(serializer);
                case "ends_with": return jObject.ToObject<EndsWithCondition>(serializer);
                case "equals": return jObject.ToObject<EqualsCondition>(serializer);
                case "exists": return jObject.ToObject<ExistsCondition>(serializer);
                ...
                case "matches_regex": return jObject.ToObject<MatchesRegexCondition>(serializer);
                ...
                case "starts_with": return jObject.ToObject<StartsWithCondition>(serializer);
