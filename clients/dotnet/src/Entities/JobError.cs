namespace Retab
{
    ...
    public class JobError
    {
        ...
        /// <summary>
        /// Typed accessor for <see cref="Details"/>. Returns the value stored under
        ...
        public T? GetDetailsAttribute<T>(string key)
        {
            ...
            if (!this.Details.TryGetValue(key, out var value))
            {
                return default;
            }
