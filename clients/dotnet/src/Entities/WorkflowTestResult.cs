namespace Retab
{
    ...
    public class WorkflowTestResult
    {
        ...
        public string? WorkflowTestRunId { get; set; }
        ...
        /// <summary>Verdict label populated only when the underlying test reaches a terminal lifecycle state and the verdict could be determined. Execution-error details flow through `lifecycle`, not through this enum.</summary>
