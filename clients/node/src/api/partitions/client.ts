...
export default class APIPartitions extends CompositionClient {
   ...
   */
  async create(params: PartitionCreateParams, options?: RequestOptions): Promise<Partition> {
    const document =
   ...
   */
  async get(partitionId: string, options?: RequestOptions): Promise<Partition> {
    return this._fetchJson(ZPartition, {
