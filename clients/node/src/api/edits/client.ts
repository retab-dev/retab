...
import { ZMIMEData, MIMEDataInput, ZEdit, Edit } from '../../types.js';
...
export default class APIEdits extends CompositionClient {
   ...
   */
  async create(params: EditCreateParams, options?: RequestOptions): Promise<Edit> {
