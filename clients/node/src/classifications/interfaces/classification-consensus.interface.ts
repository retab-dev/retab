...
export function deserializeClassificationConsensus(wire: ClassificationConsensusResponse): ClassificationConsensus {
  return {
    choices: wire["choices"] == null ? (wire["choices"] as undefined) : wire["choices"].map((__i) => deserializeClassificationDecision(__i)),
