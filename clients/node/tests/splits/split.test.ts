...
import { getEnvConfig, getFidelityFormPath } from '../fixtures';
...
const DEFAULT_SUBDOCUMENTS = [
  {
    name: 'form_section',
    description: 'Form sections with input fields, checkboxes, or signature areas',
  },
