...
class ExperimentRunResultsTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $result = $client->workflows()->experiments()->results()->list(runId: 'test_value', before: 'test_value', after: 'test_value', limit: 1, order: \Retab\Resource\EditsOrder::Asc);
    ...
    public function testPaginationBoundary(): void
    {
        ...
        $client = $this->createMockClient([['status' => 200, 'body' => $fixture]]);
        $result = $client->workflows()->experiments()->results()->list(runId: 'test_value');
        $this->assertInstanceOf(\Retab\PaginatedResponse::class, $result);
