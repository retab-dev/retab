 ...
 */
readonly class WorkflowEvalBlockTarget implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        foreach ([
            ...
            if (!array_key_exists($__required, $data)) {
                throw new \UnexpectedValueException("Missing required field '$__required' for WorkflowEvalBlockTarget::fromArray()");
            }
        }
        return new self(
