...
def test_mime_data_id_uses_retab_storage_file_id() -> None:
    mime_data = MIMEData(filename="invoice.pdf", url="https://storage.retab.com/org_1/file_123.pdf")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://storage.retab.com/org_1/file_123.pdf?x=1",
        "https://storage.retab.com/org_1/file_123.pdf#fragment",
    ],
)
