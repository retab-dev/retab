...
# We want usage for each : 
# - Link
# - Email
# - Schema ID
# - Model ID (gpt-4o-mini-2024-07-18, gpt-4o)
# - Global usage

# -> They are in the logs

# Usage sorted by schema
# client.usage.schema.list()`
# client.usage.schema.get()
# client.usage.schema.list_by_datastructures()

# Usage sorted by model
# client.usage.model.list()
# client.usage.model.get()

# Usage sorted by link
# client.usage.link.list()
# client.usage.link.get()

# Usage sorted by email
# client.usage.email.list()
# client.usage.email.get()

# Usage sorted by global
# client.usage.global.get()

# For each we just aggregate the logs
