...
class Annotation(BaseModel):
    object: Literal["annotation"] = "annotation"
    id: str = Field(default_factory=lambda: f"ann_{uuid.uuid4()}", description="Unique identifier of the annotated file")
    file_id: str = Field(description="ID of the file being annotated") 
    dataset_id: str = Field(description="ID of the annotated dataset")
