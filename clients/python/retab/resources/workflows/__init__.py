...
from .spec import AsyncWorkflowSpec, WorkflowSpec
...
__all__ = [
    ...
    "WorkflowBlocks",
    "AsyncWorkflowBlocks",
    # `WorkflowBlockExecutions` / `AsyncWorkflowBlockExecutions` are
    # NOT re-exported here. The single canonical accessor is
    # `client.workflows.blocks.executions` at runtime, and
