...
from retab.types.workflows.tests import AssertionSpec, CreateWorkflowTestRequest, ManualWorkflowTestSource, RunStepWorkflowTestSource, UpdateWorkflowTestRequest, WorkflowTest, WorkflowTestBlockTarget
...
class WorkflowTestsMixin:
    ...
    def prepare_list(self, workflow_id: str, target_block_id: str | None = None, before: str | None = None, after: str | None = None, limit: int | None = 50, order: PaginationOrder | None = cast(PaginationOrder, "desc"), **extra_params: Any) -> PreparedRequest:
    ...
    def prepare_create(self, workflow_id: str, target: WorkflowTestBlockTarget, source: ManualWorkflowTestSource | RunStepWorkflowTestSource, assertion: AssertionSpec, name: str | None = None, **extra_params: Any) -> PreparedRequest:
        ...
        if extra_params:
            params.update(extra_params)
        params = {k: v for k, v in params.items() if v is not None}
        payload = CreateWorkflowTestRequest(workflow_id=cast(Any, workflow_id), target=cast(Any, target), source=cast(Any, source), name=cast(Any, name), assertion=cast(Any, assertion))
    ...
    def prepare_update(self, test_id: str, name: str | None = None, assertion: AssertionSpec | None = None, source: ManualWorkflowTestSource | RunStepWorkflowTestSource | None = None, **extra_params: Any) -> PreparedRequest:
...
class WorkflowTests(SyncAPIResource, WorkflowTestsMixin):
    ...
    def list(self, workflow_id: str, target_block_id: str | None = None, before: str | None = None, after: str | None = None, limit: int | None = 50, order: PaginationOrder | None = cast(PaginationOrder, "desc"), **extra_params: Any) -> PaginatedList[WorkflowTest]:
        """List Tests List workflow tests. Requires `workflow_id` and returns its saved tests as a cursor-paginated list, each with its latest-run summaries and drift status. Optionally filter to one block with `target_block_id`. Returns 404 if the workflow does not exist."""
    ...
    def create(self, workflow_id: str, target: WorkflowTestBlockTarget, source: ManualWorkflowTestSource | RunStepWorkflowTestSource, assertion: AssertionSpec, name: str | None = None, **extra_params: Any) -> WorkflowTest:
        """Create Test Create a workflow test. Pins an expected outcome for one block in a workflow. Provide the `workflow_id`, the `target` block, an `assertion` describing the expected output, and a `source` of test inputs (explicit handle inputs or a capture from a prior run/step). Returns the created test with status 201."""
    ...
    def update(self, test_id: str, name: str | None = None, assertion: AssertionSpec | None = None, source: ManualWorkflowTestSource | RunStepWorkflowTestSource | None = None, **extra_params: Any) -> WorkflowTest:
        """Update Test Update a workflow test. Identified by `test_id`. Send any of `name`, `assertion`, or `source`; omitted fields are left unchanged. Returns the updated test."""
...
class AsyncWorkflowTests(AsyncAPIResource, WorkflowTestsMixin):
    ...
    async def list(self, workflow_id: str, target_block_id: str | None = None, before: str | None = None, after: str | None = None, limit: int | None = 50, order: PaginationOrder | None = cast(PaginationOrder, "desc"), **extra_params: Any) -> AsyncPaginatedList[WorkflowTest]:
        """List Tests List workflow tests. Requires `workflow_id` and returns its saved tests as a cursor-paginated list, each with its latest-run summaries and drift status. Optionally filter to one block with `target_block_id`. Returns 404 if the workflow does not exist."""
        prepared_request = self.prepare_list(workflow_id=workflow_id, target_block_id=target_block_id, before=before, after=after, limit=limit, order=order, **extra_params)
        return await self.request_page(prepared_request, model=WorkflowTest)

    async def create(self, workflow_id: str, target: WorkflowTestBlockTarget, source: ManualWorkflowTestSource | RunStepWorkflowTestSource, assertion: AssertionSpec, name: str | None = None, **extra_params: Any) -> WorkflowTest:
        """Create Test Create a workflow test. Pins an expected outcome for one block in a workflow. Provide the `workflow_id`, the `target` block, an `assertion` describing the expected output, and a `source` of test inputs (explicit handle inputs or a capture from a prior run/step). Returns the created test with status 201."""
        prepared_request = self.prepare_create(workflow_id=workflow_id, target=target, source=source, name=name, assertion=assertion, **extra_params)
    ...
    async def update(self, test_id: str, name: str | None = None, assertion: AssertionSpec | None = None, source: ManualWorkflowTestSource | RunStepWorkflowTestSource | None = None, **extra_params: Any) -> WorkflowTest:
        """Update Test Update a workflow test. Identified by `test_id`. Send any of `name`, `assertion`, or `source`; omitted fields are left unchanged. Returns the updated test."""
        prepared_request = self.prepare_update(test_id, name=name, assertion=assertion, source=source, **extra_params)
        response = await self._client._prepared_request(prepared_request)
        return WorkflowTest.model_validate(response)
...
__all__ = ["WorkflowTests", "AsyncWorkflowTests", "WorkflowTestsMixin", "WorkflowTestRunResults", "AsyncWorkflowTestRunResults", "WorkflowTestRunResultsMixin", "WorkflowTestRuns", "AsyncWorkflowTestRuns", "WorkflowTestRunsMixin"]
