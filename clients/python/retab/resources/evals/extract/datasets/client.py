...
class DatasetsMixin:
    ...
    def prepare_create(
        ...
        return PreparedRequest(method="POST", url=f"{BASE}/{project_id}/datasets", data=data)

    def prepare_get(self, project_id: str, dataset_id: str) -> PreparedRequest:
        return PreparedRequest(method="GET", url=f"{BASE}/{project_id}/datasets/{dataset_id}")
    ...
    def prepare_list(
        ...
        if after is not None:
            params["after"] = after
        return PreparedRequest(method="GET", url=f"{BASE}/{project_id}/datasets", params=params)
    ...
    def prepare_update(
        ...
        if name is not None:
            data["name"] = name
        return PreparedRequest(method="PATCH", url=f"{BASE}/{project_id}/datasets/{dataset_id}", data=data)

    def prepare_delete(self, project_id: str, dataset_id: str) -> PreparedRequest:
        return PreparedRequest(method="DELETE", url=f"{BASE}/{project_id}/datasets/{dataset_id}")

    def prepare_duplicate(self, project_id: str, dataset_id: str, name: str | None = None) -> PreparedRequest:
        data: Dict[str, Any] = {}
        if name is not None:
            data["name"] = name
        return PreparedRequest(method="POST", url=f"{BASE}/{project_id}/datasets/{dataset_id}/duplicate", data=data)
    ...
    def prepare_add_document(
        ...
        return PreparedRequest(method="POST", url=f"{BASE}/{project_id}/datasets/{dataset_id}/dataset-documents", data=data)

    def prepare_get_document(self, project_id: str, dataset_id: str, document_id: str) -> PreparedRequest:
        return PreparedRequest(method="GET", url=f"{BASE}/{project_id}/datasets/{dataset_id}/dataset-documents/{document_id}")
    ...
    def prepare_list_documents(
        ...
        return PreparedRequest(method="GET", url=f"{BASE}/{project_id}/datasets/{dataset_id}/dataset-documents", params=params)
    ...
    def prepare_update_document(
        ...
        return PreparedRequest(method="PATCH", url=f"{BASE}/{project_id}/datasets/{dataset_id}/dataset-documents/{document_id}", data=data)

    def prepare_delete_document(self, project_id: str, dataset_id: str, document_id: str) -> PreparedRequest:
        return PreparedRequest(method="DELETE", url=f"{BASE}/{project_id}/datasets/{dataset_id}/dataset-documents/{document_id}")
