...
class IterationsMixin:
    ...
    def prepare_create(
        ...
        return PreparedRequest(method="POST", url=f"/projects/{project_id}/datasets/{dataset_id}/iterations", data=data)

    def prepare_get(self, project_id: str, dataset_id: str, iteration_id: str) -> PreparedRequest:
        return PreparedRequest(method="GET", url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}")
    ...
    def prepare_list(
        ...
        if after is not None:
            params["after"] = after
        return PreparedRequest(method="GET", url=f"/projects/{project_id}/datasets/{dataset_id}/iterations", params=params)
    ...
    def prepare_update_draft(
        ...
        """Update the iteration's draft. Edits go through the draft sub-object;
        call finalize() to promote draft values to the main iteration fields."""
        draft: Dict[str, Any] = {
        ...
        return PreparedRequest(
            method="PATCH",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}",
            data={"draft": draft},
        )

    def prepare_delete(self, project_id: str, dataset_id: str, iteration_id: str) -> PreparedRequest:
        return PreparedRequest(method="DELETE", url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}")
    ...
    def prepare_finalize(self, project_id: str, dataset_id: str, iteration_id: str) -> PreparedRequest:
        ...
        return PreparedRequest(method="POST", url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/finalize")
    ...
    def prepare_get_schema(
        ...
        When use_draft=True, pending draft overrides are applied on top."""
        params: Dict[str, Any] = {}
        if use_draft:
            params["use_draft"] = True
        return PreparedRequest(
            method="GET",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/schema",
    ...
    def prepare_process_documents(
        ...
        """Trigger background extraction for an iteration document identified by its dataset_document_id."""
        return PreparedRequest(
            method="POST",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/iteration-documents/processDocumentsFromDatasetId",
    ...
    def prepare_get_document(self, project_id: str, dataset_id: str, iteration_id: str, document_id: str) -> PreparedRequest:
        return PreparedRequest(
            method="GET",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/iteration-documents/{document_id}",
        )
    ...
    def prepare_list_documents(
        ...
        return PreparedRequest(
            method="GET",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/iteration-documents",
            params=params,
        )
    ...
    def prepare_get_metrics(
        ...
        return PreparedRequest(
            method="GET",
            url=f"/projects/{project_id}/datasets/{dataset_id}/iterations/{iteration_id}/metrics",
            params=params or None,
        )
