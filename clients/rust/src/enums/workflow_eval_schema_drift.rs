...
#[non_exhaustive]
pub enum WorkflowEvalSchemaDrift {
    None,
    Partial,
    Drifted,
    Unknown,
...
impl fmt::Display for WorkflowEvalSchemaDrift {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowEvalSchemaDrift {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowEvalSchemaDrift {
...
impl From<String> for WorkflowEvalSchemaDrift {
...
impl From<&str> for WorkflowEvalSchemaDrift {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unrecognized(s.to_string()))
    }
}

impl Serialize for WorkflowEvalSchemaDrift {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowEvalSchemaDrift {
