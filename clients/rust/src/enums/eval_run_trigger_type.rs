...
impl fmt::Display for EvalRunTriggerType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EvalRunTriggerType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EvalRunTriggerType {
...
impl From<String> for EvalRunTriggerType {
...
impl From<&str> for EvalRunTriggerType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EvalRunTriggerType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EvalRunTriggerType {
