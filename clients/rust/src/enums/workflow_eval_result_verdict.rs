...
#[non_exhaustive]
pub enum WorkflowEvalResultVerdict {
    Passed,
    Failed,
    Blocked,
...
impl WorkflowEvalResultVerdict {
...
impl fmt::Display for WorkflowEvalResultVerdict {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowEvalResultVerdict {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowEvalResultVerdict {
...
impl From<String> for WorkflowEvalResultVerdict {
...
impl From<&str> for WorkflowEvalResultVerdict {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowEvalResultVerdict {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowEvalResultVerdict {
