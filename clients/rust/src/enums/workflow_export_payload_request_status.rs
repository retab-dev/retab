...
#[non_exhaustive]
pub enum WorkflowExportPayloadRequestStatus {
    Pending,
    Queued,
    Running,
    Completed,
...
impl WorkflowExportPayloadRequestStatus {
...
impl fmt::Display for WorkflowExportPayloadRequestStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowExportPayloadRequestStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowExportPayloadRequestStatus {
...
impl From<String> for WorkflowExportPayloadRequestStatus {
...
impl From<&str> for WorkflowExportPayloadRequestStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowExportPayloadRequestStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowExportPayloadRequestStatus {
