...
#[non_exhaustive]
pub enum WorkflowEvalRunsOrder {
    Asc,
    Desc,
...
impl fmt::Display for WorkflowEvalRunsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowEvalRunsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowEvalRunsOrder {
...
impl From<String> for WorkflowEvalRunsOrder {
...
impl From<&str> for WorkflowEvalRunsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowEvalRunsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowEvalRunsOrder {
