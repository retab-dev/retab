...
impl fmt::Display for EditsStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EditsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EditsStatus {
...
impl From<String> for EditsStatus {
...
impl From<&str> for EditsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EditsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EditsStatus {
