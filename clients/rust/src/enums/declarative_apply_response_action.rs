...
#[non_exhaustive]
pub enum DeclarativeApplyResponseAction {
    Create,
    Update,
    Noop,
...
impl DeclarativeApplyResponseAction {
...
impl fmt::Display for DeclarativeApplyResponseAction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DeclarativeApplyResponseAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DeclarativeApplyResponseAction {
...
impl From<String> for DeclarativeApplyResponseAction {
...
impl From<&str> for DeclarativeApplyResponseAction {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DeclarativeApplyResponseAction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DeclarativeApplyResponseAction {
