...
#[non_exhaustive]
pub enum PartitionWorkflowArtifactStatus {
    Pending,
    Queued,
    InProgress,
    Completed,
...
impl PartitionWorkflowArtifactStatus {
...
impl fmt::Display for PartitionWorkflowArtifactStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for PartitionWorkflowArtifactStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for PartitionWorkflowArtifactStatus {
...
impl From<String> for PartitionWorkflowArtifactStatus {
...
impl From<&str> for PartitionWorkflowArtifactStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for PartitionWorkflowArtifactStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for PartitionWorkflowArtifactStatus {
