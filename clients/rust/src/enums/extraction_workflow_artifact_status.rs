...
#[non_exhaustive]
pub enum ExtractionWorkflowArtifactStatus {
    Pending,
    Queued,
    InProgress,
    Completed,
...
impl ExtractionWorkflowArtifactStatus {
...
impl fmt::Display for ExtractionWorkflowArtifactStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExtractionWorkflowArtifactStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExtractionWorkflowArtifactStatus {
...
impl From<String> for ExtractionWorkflowArtifactStatus {
...
impl From<&str> for ExtractionWorkflowArtifactStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExtractionWorkflowArtifactStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExtractionWorkflowArtifactStatus {
