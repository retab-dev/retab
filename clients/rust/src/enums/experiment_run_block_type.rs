...
#[non_exhaustive]
pub enum ExperimentRunBlockType {
    Extract,
    Classifier,
    Split,
    ForEach,
...
impl fmt::Display for ExperimentRunBlockType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExperimentRunBlockType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExperimentRunBlockType {
...
impl From<String> for ExperimentRunBlockType {
...
impl From<&str> for ExperimentRunBlockType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExperimentRunBlockType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExperimentRunBlockType {
