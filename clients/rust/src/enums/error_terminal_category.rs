...
#[non_exhaustive]
pub enum ErrorTerminalCategory {
    Transient,
    Permanent,
    Quota,
...
impl fmt::Display for ErrorTerminalCategory {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ErrorTerminalCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ErrorTerminalCategory {
...
impl From<String> for ErrorTerminalCategory {
...
impl From<&str> for ErrorTerminalCategory {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ErrorTerminalCategory {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ErrorTerminalCategory {
