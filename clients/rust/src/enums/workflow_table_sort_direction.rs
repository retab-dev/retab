...
#[non_exhaustive]
pub enum WorkflowTableSortDirection {
    Asc,
    Desc,
...
impl WorkflowTableSortDirection {
...
impl fmt::Display for WorkflowTableSortDirection {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTableSortDirection {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTableSortDirection {
...
impl From<String> for WorkflowTableSortDirection {
...
impl From<&str> for WorkflowTableSortDirection {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowTableSortDirection {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTableSortDirection {
