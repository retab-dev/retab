...
impl AsRef<str> for CreateExperimentRequestNConsensus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateExperimentRequestNConsensus {
...
impl From<String> for CreateExperimentRequestNConsensus {
...
impl From<&str> for CreateExperimentRequestNConsensus {
    fn from(s: &str) -> Self {
