...
#[non_exhaustive]
pub enum WorkflowExperimentFreshnessState {
    Fresh,
    Stale,
    Unknown,
...
impl WorkflowExperimentFreshnessState {
...
impl fmt::Display for WorkflowExperimentFreshnessState {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowExperimentFreshnessState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowExperimentFreshnessState {
...
impl From<String> for WorkflowExperimentFreshnessState {
...
impl From<&str> for WorkflowExperimentFreshnessState {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unrecognized(s.to_string()))
    }
}

impl Serialize for WorkflowExperimentFreshnessState {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowExperimentFreshnessState {
