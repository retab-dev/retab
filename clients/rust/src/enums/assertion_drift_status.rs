...
impl fmt::Display for AssertionDriftStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AssertionDriftStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AssertionDriftStatus {
...
impl From<String> for AssertionDriftStatus {
...
impl From<&str> for AssertionDriftStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AssertionDriftStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AssertionDriftStatus {
