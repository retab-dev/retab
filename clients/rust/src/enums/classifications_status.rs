...
#[non_exhaustive]
pub enum ClassificationsStatus {
    Pending,
    Queued,
    InProgress,
    Completed,
...
impl fmt::Display for ClassificationsStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ClassificationsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ClassificationsStatus {
...
impl From<String> for ClassificationsStatus {
...
impl From<&str> for ClassificationsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ClassificationsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ClassificationsStatus {
