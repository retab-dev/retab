...
#[non_exhaustive]
pub enum WorkflowDiagnosisIssueSeverity {
    Error,
    Warning,
    Info,
...
impl WorkflowDiagnosisIssueSeverity {
...
impl fmt::Display for WorkflowDiagnosisIssueSeverity {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowDiagnosisIssueSeverity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowDiagnosisIssueSeverity {
...
impl From<String> for WorkflowDiagnosisIssueSeverity {
...
impl From<&str> for WorkflowDiagnosisIssueSeverity {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowDiagnosisIssueSeverity {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowDiagnosisIssueSeverity {
