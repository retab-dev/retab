...
#[non_exhaustive]
pub enum ExperimentResultBlockType {
    Extract,
    Classifier,
    Split,
    ForEach,
...
impl ExperimentResultBlockType {
...
impl fmt::Display for ExperimentResultBlockType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExperimentResultBlockType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExperimentResultBlockType {
...
impl From<String> for ExperimentResultBlockType {
...
impl From<&str> for ExperimentResultBlockType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExperimentResultBlockType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExperimentResultBlockType {
