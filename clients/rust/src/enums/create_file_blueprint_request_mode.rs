...
#[non_exhaustive]
pub enum CreateFileBlueprintRequestMode {
    Instant,
    Reasoning,
...
impl CreateFileBlueprintRequestMode {
...
impl fmt::Display for CreateFileBlueprintRequestMode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateFileBlueprintRequestMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateFileBlueprintRequestMode {
...
impl From<String> for CreateFileBlueprintRequestMode {
...
impl From<&str> for CreateFileBlueprintRequestMode {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateFileBlueprintRequestMode {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateFileBlueprintRequestMode {
