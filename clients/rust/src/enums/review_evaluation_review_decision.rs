...
#[non_exhaustive]
pub enum ReviewEvaluationReviewDecision {
    Approved,
    Rejected,
...
impl ReviewEvaluationReviewDecision {
...
impl fmt::Display for ReviewEvaluationReviewDecision {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ReviewEvaluationReviewDecision {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ReviewEvaluationReviewDecision {
...
impl From<String> for ReviewEvaluationReviewDecision {
...
impl From<&str> for ReviewEvaluationReviewDecision {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ReviewEvaluationReviewDecision {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ReviewEvaluationReviewDecision {
