...
#[non_exhaustive]
pub enum ExperimentRunMetricsView {
    Summary,
    ByDocument,
    ByTarget,
    Votes,
...
impl ExperimentRunMetricsView {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::ByDocument => "by_document",
            Self::ByTarget => "by_target",
            Self::Votes => "votes",
...
impl fmt::Display for ExperimentRunMetricsView {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExperimentRunMetricsView {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExperimentRunMetricsView {
    type Err = std::convert::Infallible;
    #[allow(deprecated)]
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            "summary" => Self::Summary,
            "by_document" => Self::ByDocument,
            "by_target" => Self::ByTarget,
            "votes" => Self::Votes,
...
impl From<String> for ExperimentRunMetricsView {
...
impl From<&str> for ExperimentRunMetricsView {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExperimentRunMetricsView {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExperimentRunMetricsView {
