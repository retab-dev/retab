...
#[non_exhaustive]
pub enum UpdateExperimentRequestNConsensus {
    V3,
    V5,
    V7,
...
impl UpdateExperimentRequestNConsensus {
...
impl fmt::Display for UpdateExperimentRequestNConsensus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for UpdateExperimentRequestNConsensus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for UpdateExperimentRequestNConsensus {
...
impl From<String> for UpdateExperimentRequestNConsensus {
...
impl From<&str> for UpdateExperimentRequestNConsensus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for UpdateExperimentRequestNConsensus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for UpdateExperimentRequestNConsensus {
