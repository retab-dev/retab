...
#[non_exhaustive]
pub enum WorkflowExperimentsOrder {
    Asc,
    Desc,
...
impl fmt::Display for WorkflowExperimentsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowExperimentsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowExperimentsOrder {
...
impl From<String> for WorkflowExperimentsOrder {
...
impl From<&str> for WorkflowExperimentsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowExperimentsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowExperimentsOrder {
