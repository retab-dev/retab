...
#[non_exhaustive]
pub enum EditWorkflowArtifactStatus {
    Pending,
    Queued,
    InProgress,
    Completed,
...
impl EditWorkflowArtifactStatus {
...
impl fmt::Display for EditWorkflowArtifactStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EditWorkflowArtifactStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EditWorkflowArtifactStatus {
...
impl From<String> for EditWorkflowArtifactStatus {
...
impl From<&str> for EditWorkflowArtifactStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EditWorkflowArtifactStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EditWorkflowArtifactStatus {
