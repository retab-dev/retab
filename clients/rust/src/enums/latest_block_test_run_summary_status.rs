...
#[non_exhaustive]
pub enum LatestBlockTestRunSummaryStatus {
    Pending,
    Queued,
    Running,
    Completed,
...
impl LatestBlockTestRunSummaryStatus {
...
impl fmt::Display for LatestBlockTestRunSummaryStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for LatestBlockTestRunSummaryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for LatestBlockTestRunSummaryStatus {
...
impl From<String> for LatestBlockTestRunSummaryStatus {
...
impl From<&str> for LatestBlockTestRunSummaryStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for LatestBlockTestRunSummaryStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for LatestBlockTestRunSummaryStatus {
