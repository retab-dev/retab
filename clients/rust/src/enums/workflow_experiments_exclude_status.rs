...
#[non_exhaustive]
pub enum WorkflowExperimentsExcludeStatus {
    Pending,
    Queued,
    Running,
    Completed,
...
impl WorkflowExperimentsExcludeStatus {
...
impl fmt::Display for WorkflowExperimentsExcludeStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowExperimentsExcludeStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowExperimentsExcludeStatus {
...
impl From<String> for WorkflowExperimentsExcludeStatus {
...
impl From<&str> for WorkflowExperimentsExcludeStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowExperimentsExcludeStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowExperimentsExcludeStatus {
