...
#[non_exhaustive]
pub enum LatestBlockEvalRunSummaryStatus {
    Pending,
    Queued,
    Running,
    Completed,
...
impl LatestBlockEvalRunSummaryStatus {
...
impl fmt::Display for LatestBlockEvalRunSummaryStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for LatestBlockEvalRunSummaryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for LatestBlockEvalRunSummaryStatus {
...
impl From<String> for LatestBlockEvalRunSummaryStatus {
...
impl From<&str> for LatestBlockEvalRunSummaryStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for LatestBlockEvalRunSummaryStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for LatestBlockEvalRunSummaryStatus {
