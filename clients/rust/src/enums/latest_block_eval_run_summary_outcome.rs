...
#[non_exhaustive]
pub enum LatestBlockEvalRunSummaryOutcome {
    Passed,
    Failed,
    Blocked,
...
impl LatestBlockEvalRunSummaryOutcome {
...
impl fmt::Display for LatestBlockEvalRunSummaryOutcome {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for LatestBlockEvalRunSummaryOutcome {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for LatestBlockEvalRunSummaryOutcome {
...
impl From<String> for LatestBlockEvalRunSummaryOutcome {
...
impl From<&str> for LatestBlockEvalRunSummaryOutcome {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for LatestBlockEvalRunSummaryOutcome {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for LatestBlockEvalRunSummaryOutcome {
