...
#[non_exhaustive]
pub enum ExperimentRunResultsOrder {
    Asc,
    Desc,
...
impl ExperimentRunResultsOrder {
...
impl fmt::Display for ExperimentRunResultsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExperimentRunResultsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExperimentRunResultsOrder {
...
impl From<String> for ExperimentRunResultsOrder {
...
impl From<&str> for ExperimentRunResultsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExperimentRunResultsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExperimentRunResultsOrder {
