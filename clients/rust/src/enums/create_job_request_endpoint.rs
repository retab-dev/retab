...
#[non_exhaustive]
pub enum CreateJobRequestEndpoint {
    V1Extractions,
    V1Parses,
    V1Splits,
    V1Partitions,
...
impl fmt::Display for CreateJobRequestEndpoint {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateJobRequestEndpoint {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateJobRequestEndpoint {
...
impl From<String> for CreateJobRequestEndpoint {
...
impl From<&str> for CreateJobRequestEndpoint {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateJobRequestEndpoint {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateJobRequestEndpoint {
