...
#[non_exhaustive]
pub enum SimilarityGteConditionMethod {
    Levenshtein,
    Embeddings,
...
impl SimilarityGteConditionMethod {
...
impl fmt::Display for SimilarityGteConditionMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SimilarityGteConditionMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SimilarityGteConditionMethod {
...
impl From<String> for SimilarityGteConditionMethod {
...
impl From<&str> for SimilarityGteConditionMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SimilarityGteConditionMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SimilarityGteConditionMethod {
