...
#[non_exhaustive]
pub enum WorkflowTableValidationSeverity {
    Error,
    Warning,
...
impl WorkflowTableValidationSeverity {
...
impl fmt::Display for WorkflowTableValidationSeverity {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTableValidationSeverity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTableValidationSeverity {
...
impl From<String> for WorkflowTableValidationSeverity {
...
impl From<&str> for WorkflowTableValidationSeverity {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowTableValidationSeverity {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTableValidationSeverity {
