...
#[non_exhaustive]
pub enum WorkflowTestRunResultsOrder {
    Asc,
    Desc,
...
impl WorkflowTestRunResultsOrder {
...
impl fmt::Display for WorkflowTestRunResultsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTestRunResultsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTestRunResultsOrder {
...
impl From<String> for WorkflowTestRunResultsOrder {
...
impl From<&str> for WorkflowTestRunResultsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowTestRunResultsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTestRunResultsOrder {
