...
#[non_exhaustive]
pub enum NumberCompareConditionOp {
    Gt,
    Gte,
    Lt,
    Lte,
...
impl fmt::Display for NumberCompareConditionOp {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for NumberCompareConditionOp {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for NumberCompareConditionOp {
...
impl From<String> for NumberCompareConditionOp {
...
impl From<&str> for NumberCompareConditionOp {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for NumberCompareConditionOp {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for NumberCompareConditionOp {
