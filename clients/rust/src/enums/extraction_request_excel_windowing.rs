...
#[non_exhaustive]
pub enum ExtractionRequestExcelWindowing {
    Manual,
    Auto,
...
impl ExtractionRequestExcelWindowing {
...
impl fmt::Display for ExtractionRequestExcelWindowing {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ExtractionRequestExcelWindowing {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ExtractionRequestExcelWindowing {
...
impl From<String> for ExtractionRequestExcelWindowing {
...
impl From<&str> for ExtractionRequestExcelWindowing {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ExtractionRequestExcelWindowing {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ExtractionRequestExcelWindowing {
