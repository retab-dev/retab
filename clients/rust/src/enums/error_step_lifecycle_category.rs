...
#[non_exhaustive]
pub enum ErrorStepLifecycleCategory {
    Transient,
    Permanent,
    Quota,
...
impl ErrorStepLifecycleCategory {
...
impl fmt::Display for ErrorStepLifecycleCategory {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ErrorStepLifecycleCategory {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ErrorStepLifecycleCategory {
...
impl From<String> for ErrorStepLifecycleCategory {
...
impl From<&str> for ErrorStepLifecycleCategory {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ErrorStepLifecycleCategory {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ErrorStepLifecycleCategory {
