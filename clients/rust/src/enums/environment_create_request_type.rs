...
#[non_exhaustive]
pub enum EnvironmentCreateRequestType {
    Production,
    NonProduction,
...
impl EnvironmentCreateRequestType {
...
impl fmt::Display for EnvironmentCreateRequestType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EnvironmentCreateRequestType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EnvironmentCreateRequestType {
    type Err = std::convert::Infallible;
    #[allow(deprecated)]
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            "production" => Self::Production,
            "non_production" => Self::NonProduction,
            other => Self::Unknown(other.to_string()),
        })
    }
}

impl From<String> for EnvironmentCreateRequestType {
...
impl From<&str> for EnvironmentCreateRequestType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EnvironmentCreateRequestType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EnvironmentCreateRequestType {
