...
#[non_exhaustive]
pub enum EvalRunFreshnessReasons {
    ValidityChanged,
    InputsChanged,
    EngineChanged,
...
impl fmt::Display for EvalRunFreshnessReasons {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EvalRunFreshnessReasons {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EvalRunFreshnessReasons {
...
impl From<String> for EvalRunFreshnessReasons {
...
impl From<&str> for EvalRunFreshnessReasons {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for EvalRunFreshnessReasons {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EvalRunFreshnessReasons {
