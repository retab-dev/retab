...
#[non_exhaustive]
pub enum LatestBlockTestRunSummaryOutcome {
    Passed,
    Failed,
    Blocked,
...
impl LatestBlockTestRunSummaryOutcome {
...
impl fmt::Display for LatestBlockTestRunSummaryOutcome {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for LatestBlockTestRunSummaryOutcome {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for LatestBlockTestRunSummaryOutcome {
...
impl From<String> for LatestBlockTestRunSummaryOutcome {
...
impl From<&str> for LatestBlockTestRunSummaryOutcome {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for LatestBlockTestRunSummaryOutcome {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for LatestBlockTestRunSummaryOutcome {
