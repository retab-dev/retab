...
#[non_exhaustive]
pub enum WorkflowTestSchemaDrift {
    None,
    Partial,
    Drifted,
    Unknown,
...
impl fmt::Display for WorkflowTestSchemaDrift {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTestSchemaDrift {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTestSchemaDrift {
...
impl From<String> for WorkflowTestSchemaDrift {
...
impl From<&str> for WorkflowTestSchemaDrift {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unrecognized(s.to_string()))
    }
}

impl Serialize for WorkflowTestSchemaDrift {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTestSchemaDrift {
