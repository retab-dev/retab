...
#[non_exhaustive]
pub enum WorkflowBlockExecutionsOrder {
    Asc,
    Desc,
...
impl WorkflowBlockExecutionsOrder {
...
impl fmt::Display for WorkflowBlockExecutionsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowBlockExecutionsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowBlockExecutionsOrder {
...
impl From<String> for WorkflowBlockExecutionsOrder {
...
impl From<&str> for WorkflowBlockExecutionsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowBlockExecutionsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowBlockExecutionsOrder {
