...
impl AsRef<str> for ClassificationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl From<String> for ClassificationStatus {
...
impl From<&str> for ClassificationStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for ClassificationStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ClassificationStatus {
