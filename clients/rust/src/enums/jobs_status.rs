...
impl AsRef<str> for JobsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for JobsStatus {
...
impl From<String> for JobsStatus {
...
impl From<&str> for JobsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for JobsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for JobsStatus {
