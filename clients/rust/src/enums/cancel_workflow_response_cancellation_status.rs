...
#[non_exhaustive]
pub enum CancelWorkflowResponseCancellationStatus {
    Cancelled,
...
impl CancelWorkflowResponseCancellationStatus {
...
impl fmt::Display for CancelWorkflowResponseCancellationStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CancelWorkflowResponseCancellationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CancelWorkflowResponseCancellationStatus {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "cancellation_failed" => Self::CancellationFailed,
            other => Self::Unknown(other.to_string()),
        })
    }
}

impl From<String> for CancelWorkflowResponseCancellationStatus {
...
impl From<&str> for CancelWorkflowResponseCancellationStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CancelWorkflowResponseCancellationStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CancelWorkflowResponseCancellationStatus {
