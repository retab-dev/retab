...
#[non_exhaustive]
pub enum AuthStatusEnvironmentType {
    Production,
    NonProduction,
...
impl AuthStatusEnvironmentType {
...
impl fmt::Display for AuthStatusEnvironmentType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AuthStatusEnvironmentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AuthStatusEnvironmentType {
...
impl From<String> for AuthStatusEnvironmentType {
...
impl From<&str> for AuthStatusEnvironmentType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AuthStatusEnvironmentType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AuthStatusEnvironmentType {
