...
#[non_exhaustive]
pub enum LengthCompareConditionOp {
    Gt,
    Gte,
    Lt,
    Lte,
...
impl fmt::Display for LengthCompareConditionOp {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for LengthCompareConditionOp {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for LengthCompareConditionOp {
...
impl From<String> for LengthCompareConditionOp {
...
impl From<&str> for LengthCompareConditionOp {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for LengthCompareConditionOp {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for LengthCompareConditionOp {
