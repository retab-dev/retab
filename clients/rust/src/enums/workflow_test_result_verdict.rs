...
#[non_exhaustive]
pub enum WorkflowTestResultVerdict {
    Passed,
    Failed,
    Blocked,
...
impl WorkflowTestResultVerdict {
...
impl fmt::Display for WorkflowTestResultVerdict {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTestResultVerdict {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTestResultVerdict {
...
impl From<String> for WorkflowTestResultVerdict {
...
impl From<&str> for WorkflowTestResultVerdict {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowTestResultVerdict {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTestResultVerdict {
