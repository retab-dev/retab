...
#[non_exhaustive]
pub enum DeclarativePlanResourceChangeTarget {
    Workflow,
    Block,
    Edge,
...
impl DeclarativePlanResourceChangeTarget {
...
impl fmt::Display for DeclarativePlanResourceChangeTarget {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DeclarativePlanResourceChangeTarget {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DeclarativePlanResourceChangeTarget {
...
impl From<String> for DeclarativePlanResourceChangeTarget {
...
impl From<&str> for DeclarativePlanResourceChangeTarget {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DeclarativePlanResourceChangeTarget {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DeclarativePlanResourceChangeTarget {
