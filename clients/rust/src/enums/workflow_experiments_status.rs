...
#[non_exhaustive]
pub enum WorkflowExperimentsStatus {
    Pending,
    Queued,
    Running,
    Completed,
...
impl WorkflowExperimentsStatus {
...
impl fmt::Display for WorkflowExperimentsStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowExperimentsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowExperimentsStatus {
...
impl From<String> for WorkflowExperimentsStatus {
...
impl From<&str> for WorkflowExperimentsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowExperimentsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowExperimentsStatus {
