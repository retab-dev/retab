...
#[non_exhaustive]
pub enum EvalRunFreshnessStatus {
    Fresh,
    Stale,
    Unknown,
...
impl fmt::Display for EvalRunFreshnessStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for EvalRunFreshnessStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EvalRunFreshnessStatus {
...
impl From<String> for EvalRunFreshnessStatus {
...
impl From<&str> for EvalRunFreshnessStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unrecognized(s.to_string()))
    }
}

impl Serialize for EvalRunFreshnessStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for EvalRunFreshnessStatus {
