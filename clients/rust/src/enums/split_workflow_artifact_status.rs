...
#[non_exhaustive]
pub enum SplitWorkflowArtifactStatus {
    Pending,
    Queued,
    InProgress,
    Completed,
...
impl SplitWorkflowArtifactStatus {
...
impl fmt::Display for SplitWorkflowArtifactStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SplitWorkflowArtifactStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SplitWorkflowArtifactStatus {
...
impl From<String> for SplitWorkflowArtifactStatus {
...
impl From<&str> for SplitWorkflowArtifactStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SplitWorkflowArtifactStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SplitWorkflowArtifactStatus {
