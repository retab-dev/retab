...
#[non_exhaustive]
pub enum WorkflowBlockCreateRequestType {
    StartDocument,
    StartJson,
    Note,
    Parse,
...
impl WorkflowBlockCreateRequestType {
...
impl fmt::Display for WorkflowBlockCreateRequestType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowBlockCreateRequestType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowBlockCreateRequestType {
...
impl From<String> for WorkflowBlockCreateRequestType {
...
impl From<&str> for WorkflowBlockCreateRequestType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowBlockCreateRequestType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowBlockCreateRequestType {
