...
#[non_exhaustive]
pub enum DeclarativePlanFieldChangeAction {
    Create,
    Update,
    Delete,
...
impl DeclarativePlanFieldChangeAction {
...
impl fmt::Display for DeclarativePlanFieldChangeAction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DeclarativePlanFieldChangeAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DeclarativePlanFieldChangeAction {
...
impl From<String> for DeclarativePlanFieldChangeAction {
...
impl From<&str> for DeclarativePlanFieldChangeAction {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DeclarativePlanFieldChangeAction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DeclarativePlanFieldChangeAction {
