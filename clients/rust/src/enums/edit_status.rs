...
impl AsRef<str> for EditStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for EditStatus {
...
impl From<String> for EditStatus {
...
impl<'de> Deserialize<'de> for EditStatus {
