...
#[non_exhaustive]
pub enum WorkflowTestRunsOrder {
    Asc,
    Desc,
...
impl fmt::Display for WorkflowTestRunsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowTestRunsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowTestRunsOrder {
...
impl From<String> for WorkflowTestRunsOrder {
...
impl From<&str> for WorkflowTestRunsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowTestRunsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowTestRunsOrder {
