...
impl fmt::Display for ArtifactFreshnessStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for ArtifactFreshnessStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for ArtifactFreshnessStatus {
...
impl From<String> for ArtifactFreshnessStatus {
...
impl From<&str> for ArtifactFreshnessStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unrecognized(s.to_string()))
    }
}

impl Serialize for ArtifactFreshnessStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for ArtifactFreshnessStatus {
