...
#[non_exhaustive]
pub enum DeclarativePlanResponseAction {
    Create,
    Update,
    Noop,
...
impl DeclarativePlanResponseAction {
...
impl fmt::Display for DeclarativePlanResponseAction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for DeclarativePlanResponseAction {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for DeclarativePlanResponseAction {
...
impl From<String> for DeclarativePlanResponseAction {
...
impl From<&str> for DeclarativePlanResponseAction {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for DeclarativePlanResponseAction {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for DeclarativePlanResponseAction {
