...
#[non_exhaustive]
pub enum WorkflowEvalRunResultsOrder {
    Asc,
    Desc,
...
impl WorkflowEvalRunResultsOrder {
...
impl fmt::Display for WorkflowEvalRunResultsOrder {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for WorkflowEvalRunResultsOrder {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for WorkflowEvalRunResultsOrder {
...
impl From<String> for WorkflowEvalRunResultsOrder {
...
impl From<&str> for WorkflowEvalRunResultsOrder {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for WorkflowEvalRunResultsOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for WorkflowEvalRunResultsOrder {
