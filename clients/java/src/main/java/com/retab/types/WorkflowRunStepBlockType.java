...
public enum WorkflowRunStepBlockType {
  ...
  WorkflowRunStepBlockType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WorkflowRunStepBlockType fromValue(String value) {
    for (WorkflowRunStepBlockType item : values()) {
