...
public enum WorkflowConfigBlockType {
  ...
  WorkflowConfigBlockType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WorkflowConfigBlockType fromValue(String value) {
    for (WorkflowConfigBlockType item : values()) {
