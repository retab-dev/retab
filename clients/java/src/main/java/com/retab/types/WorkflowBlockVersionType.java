...
public enum WorkflowBlockVersionType {
  ...
  WorkflowBlockVersionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WorkflowBlockVersionType fromValue(String value) {
    for (WorkflowBlockVersionType item : values()) {
