...
import com.retab.types.SplitsStatus;
...
public final class SplitsApi {
  private final RetabClient client;

  public SplitsApi(RetabClient client) {
    this.client = client;
  }
  ...
  public List<Split> list(
    ...
    return client
        .getObjectMapper()
        .readValue(data.traverse(client.getObjectMapper()), new TypeReference<List<Split>>() {});
  }

  public Split create(SplitRequest request) throws IOException, InterruptedException {
    return create(
