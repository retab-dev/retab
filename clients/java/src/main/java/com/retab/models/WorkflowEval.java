...
import com.retab.types.WorkflowEvalSchemaDrift;
...
public final class WorkflowEval {
  ...
  private final WorkflowEvalSchemaDrift schemaDrift;
  ...
  private final LatestBlockEvalRunSummary latestRunSummary;
  private final LatestBlockEvalRunSummary latestPassingRunSummary;
  private final LatestBlockEvalRunSummary latestFailingRunSummary;
  ...
  public WorkflowEval(
      ...
      @JsonProperty(value = "schema_drift", required = false) WorkflowEvalSchemaDrift schemaDrift,
      ...
      @JsonProperty(value = "latest_run_summary", required = false)
          LatestBlockEvalRunSummary latestRunSummary,
      @JsonProperty(value = "latest_passing_run_summary", required = false)
          LatestBlockEvalRunSummary latestPassingRunSummary,
      @JsonProperty(value = "latest_failing_run_summary", required = false)
          LatestBlockEvalRunSummary latestFailingRunSummary,
  ...
  public WorkflowEvalSchemaDrift getSchemaDrift() {
    return schemaDrift;
  }
  ...
  public LatestBlockEvalRunSummary getLatestRunSummary() {
    return latestRunSummary;
  }

  @JsonProperty("latest_passing_run_summary")
  public LatestBlockEvalRunSummary getLatestPassingRunSummary() {
    return latestPassingRunSummary;
  }

  @JsonProperty("latest_failing_run_summary")
  public LatestBlockEvalRunSummary getLatestFailingRunSummary() {
