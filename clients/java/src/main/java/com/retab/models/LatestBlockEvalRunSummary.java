...
import com.retab.types.LatestBlockEvalRunSummaryOutcome;
import com.retab.types.LatestBlockEvalRunSummaryStatus;
import java.time.OffsetDateTime;

@JsonIgnoreProperties(ignoreUnknown = true)
public final class LatestBlockEvalRunSummary {
  private final String runRecordId;
  private final LatestBlockEvalRunSummaryStatus status;
  private final LatestBlockEvalRunSummaryOutcome outcome;
  ...
  @JsonCreator
  public LatestBlockEvalRunSummary(
      @JsonProperty(value = "run_record_id", required = true) String runRecordId,
      @JsonProperty(value = "status", required = true) LatestBlockEvalRunSummaryStatus status,
      @JsonProperty(value = "outcome", required = false) LatestBlockEvalRunSummaryOutcome outcome,
  ...
  @JsonProperty("status")
  public LatestBlockEvalRunSummaryStatus getStatus() {
    return status;
  }

  @JsonProperty("outcome")
  public LatestBlockEvalRunSummaryOutcome getOutcome() {
    return outcome;
  }
