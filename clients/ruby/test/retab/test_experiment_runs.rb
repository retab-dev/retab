...
class ExperimentRunsTest < Minitest::Test
  ...
  [
    { name: :list, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/runs(\?|\z)} },
    { name: :create, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/runs(\?|\z)}, args: { experiment_id: "stub" } },
    { name: :get, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/runs/stub(\?|\z)}, args: { run_id: "stub" } },
    { name: :cancel, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/runs/stub/cancel(\?|\z)}, args: { run_id: "stub" } },
  ].each do |spec|
