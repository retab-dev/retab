...
class WorkflowsTest < Minitest::Test
  ...
  [
    ...
    { name: :update, verb: :patch, url: %r{\Ahttps://api\.retab\.com/v1/workflows/stub(\?|\z)}, args: { workflow_id: "stub" } },
    { name: :delete, verb: :delete, url: %r{\Ahttps://api\.retab\.com/v1/workflows/stub(\?|\z)}, args: { workflow_id: "stub" } },
    { name: :diagnose, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/stub/diagnose-graph(\?|\z)}, args: { workflow_id: "stub" } },
    { name: :publish, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/stub/publish(\?|\z)}, args: { workflow_id: "stub" } },
  ].each do |spec|
