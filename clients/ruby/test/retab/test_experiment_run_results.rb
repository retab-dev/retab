...
class ExperimentRunResultsTest < Minitest::Test
  ...
  [
    { name: :list, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/results(\?|\z)}, args: { run_id: "stub" } },
    { name: :get, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/results/stub(\?|\z)}, args: { result_id: "stub" } },
  ].each do |spec|
