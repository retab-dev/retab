...
class PartitionsTest < Minitest::Test
  ...
  def test_create_returns_expected_result
    ...
    result = @client.partitions.create(document: { filename: 'stub.pdf', url: 'data:application/pdf;base64,c3R1Yg==' }, key: "stub", instructions: "stub")
    refute_nil result
  end
  ...
  [
    ...
    { name: :create, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/partitions(\?|\z)}, args: { document: { filename: 'stub.pdf', url: 'data:application/pdf;base64,c3R1Yg==' }, key: "stub", instructions: "stub" } },
    { name: :get, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/partitions/stub(\?|\z)}, args: { partition_id: "stub" } },
    { name: :delete, verb: :delete, url: %r{\Ahttps://api\.retab\.com/v1/partitions/stub(\?|\z)}, args: { partition_id: "stub" } },
  ].each do |spec|
