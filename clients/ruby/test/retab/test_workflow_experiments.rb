...
class WorkflowExperimentsTest < Minitest::Test
  ...
  [
    { name: :list, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments(\?|\z)}, args: { workflow_id: "stub" } },
    { name: :create, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments(\?|\z)}, args: { workflow_id: "stub" } },
    { name: :get, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/stub(\?|\z)}, args: { experiment_id: "stub" } },
    { name: :update, verb: :patch, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/stub(\?|\z)}, args: { experiment_id: "stub" } },
    { name: :delete, verb: :delete, url: %r{\Ahttps://api\.retab\.com/v1/workflows/experiments/stub(\?|\z)}, args: { experiment_id: "stub" } },
  ].each do |spec|
