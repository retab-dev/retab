...
class SplitsTest < Minitest::Test
  ...
  def test_create_returns_expected_result
    ...
    result = @client.splits.create(document: { filename: 'stub.pdf', url: 'data:application/pdf;base64,c3R1Yg==' }, subdocuments: [{}])
    refute_nil result
  end
  ...
  [
    ...
    { name: :create, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/splits(\?|\z)}, args: { document: { filename: 'stub.pdf', url: 'data:application/pdf;base64,c3R1Yg==' }, subdocuments: [{}] } },
