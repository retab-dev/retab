...
class WorkflowBlockExecutionsTest < Minitest::Test
  ...
  [
    { name: :list, verb: :get, url: %r{\Ahttps://api\.retab\.com/v1/workflows/blocks/executions(\?|\z)}, args: { run_id: "stub", block_id: "stub" } },
    { name: :create, verb: :post, url: %r{\Ahttps://api\.retab\.com/v1/workflows/blocks/executions(\?|\z)}, args: { run_id: "stub", block_id: "stub" } },
  ].each do |spec|
