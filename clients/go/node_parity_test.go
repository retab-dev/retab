...
func TestNodeParityRootNamespacesAreInstalled(t *testing.T) {
	...
	if client.Workflows.Artifacts == nil || client.Workflows.BlockExecutions == nil || client.Workflows.Blocks == nil || client.Workflows.Edges == nil || client.Workflows.Tests == nil || client.Workflows.Tests.Runs == nil {
