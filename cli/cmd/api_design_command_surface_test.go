...
func TestRemovedCommandSurfaceIsAbsent(t *testing.T) {
	...
	removedPaths := []string{
		...
		"workflows blocks pull-config",
		"workflows blocks push-config",
		"workflows blocks diff-config",
		"workflows blocks validate-config",
		"workflows blocks doctor-config",
...
func TestCoreAPIResourcesExposeExpectedCommandSurface(t *testing.T) {
	expectedChildren := map[string][]string{
		...
		"org":                           {"list", "switch"},
		"invitations":                   {"list", "create", "delete"},
		"members":                       {"list", "update", "remove", "permissions"},
		"classifications":               {"create", "get", "list", "delete", "cancel", "wait"},
		"edits":                         {"create", "get", "list", "delete", "cancel", "wait", "templates"},
		"edits templates":               {"create", "get", "list", "update", "delete"},
		"extractions":                   {"create", "stream", "list", "get", "sources", "delete", "cancel", "wait"},
		...
		"parses":                        {"create", "get", "list", "delete", "cancel", "wait"},
		"partitions":                    {"create", "get", "list", "delete", "cancel", "wait"},
		...
		"splits":                        {"create", "get", "list", "delete", "cancel", "reconstruct", "wait"},
		"tables":                        {"create", "delete", "download", "get", "list", "profile", "query", "replace", "schema", "validate"},
		"workflows":                     {"list", "get", "create", "update", "delete", "publish", "discard-draft", "versions", "view", "runs", "steps", "blocks", "edges", "artifacts", "reviews", "evals", "experiments", "spec", "access", "stats"},
		"workflows access":              {"list", "grant", "get", "update", "revoke"},
		"workflows artifacts":           {"get", "list"},
		"workflows stats":               {"get", "blocks"},
		"workflows stats blocks":        {"get"},
		"workflows blocks":              {"list", "get", "create", "update", "delete", "versions", "executions", "runs", "stats", "history", "config", "api-calls", "functions"},
		"workflows blocks runs":         {"list"},
		"workflows blocks stats":        {"get"},
		"workflows blocks history":      {"list"},
