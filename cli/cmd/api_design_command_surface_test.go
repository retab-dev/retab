...
func TestAPICommandSurfaceUsesCanonicalResourceActionNames(t *testing.T) {
	canonicalNames := map[string]bool{
		...
		"setup": true, "block-executions": true, "sources": true, "spec": true,
...
func TestCoreAPIResourcesExposeExpectedCommandSurface(t *testing.T) {
	expectedChildren := map[string][]string{
		...
		"workflows":                          {"list", "get", "create", "update", "delete", "publish", "diagnose", "view", "runs", "steps", "blocks", "edges", "artifacts", "reviews", "block-executions", "tests", "experiments", "spec"},
		...
		"workflows block-executions":         {"create", "list"},
