...
func TestAPICommandSurfaceUsesCanonicalResourceActionNames(t *testing.T) {
	canonicalNames := map[string]bool{
		"add": true, "api-calls": true, "apply": true, "apply-to": true, "approve": true, "artifacts": true, "auth": true,
		...
		"diff": true, "diff-config": true, "doctor-config": true, "download": true, "download-link": true, "edges": true, "edits": true,
		...
		"upload": true, "validate": true, "validate-config": true, "value": true, "versions": true, "version": true, "version-restore": true,
...
func TestCoreAPIResourcesExposeExpectedCommandSurface(t *testing.T) {
	expectedChildren := map[string][]string{
		...
		"workflows":                     {"list", "get", "create", "update", "delete", "publish", "discard-draft", "versions", "diff", "version", "version-restore", "view", "runs", "steps", "blocks", "edges", "artifacts", "reviews", "tests", "experiments", "spec"},
		"workflows artifacts":           {"get", "list"},
		"workflows blocks":              {"list", "get", "create", "update", "delete", "versions", "diff", "version", "version-restore", "executions", "pull-config", "push-config", "diff-config", "validate-config", "doctor-config", "api-calls", "functions"},
		"workflows blocks api-calls":    {"hydrate", "render", "run"},
		"workflows blocks functions":    {"hydrate", "run"},
		"workflows edges":               {"list", "get", "create", "delete", "versions", "diff", "version", "version-restore"},
		...
		"workflows spec":                {"validate", "plan", "plan-to", "apply", "apply-to", "get"},
