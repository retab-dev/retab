...
func TestCoreAPIResourcesExposeExpectedCommandSurface(t *testing.T) {
	expectedChildren := map[string][]string{
		...
		"classifications":               {"create", "get", "list", "cancel", "wait"},
		"edits":                         {"create", "get", "list", "cancel", "wait", "templates"},
		"edits templates":               {"create", "get", "list", "update", "delete"},
		"extractions":                   {"create", "stream", "list", "get", "sources", "cancel", "wait"},
		...
		"parses":                        {"create", "get", "list", "cancel", "wait"},
		"partitions":                    {"create", "get", "list", "cancel", "wait"},
		...
		"splits":                        {"create", "get", "list", "cancel", "wait"},
