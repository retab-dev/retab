...
func TestAPICommandSurfaceUsesCanonicalResourceActionNames(t *testing.T) {
	canonicalNames := map[string]bool{
		...
		"fill": true, "generate": true, "get": true, "jobs": true,
		...
		"setup": true, "simulations": true, "sources": true, "spec": true,
...
func TestAPICommandSurfaceFlagsUseCanonicalKebabCase(t *testing.T) {
	removedFlags := map[string]string{
		...
		"simulate":       "removed simulate compatibility flag",
	}
...
func TestRemovedWorkflowCommandSurfaceIsAbsent(t *testing.T) {
	...
	removedPaths := []string{
		...
		"workflows runs simulations",
		"workflows runs simulations create",
		"workflows runs simulations list",
		"workflows runs reviews",
		"workflows runs tests",
		"workflows tests simulate",
		"workflows tests runs simulate",
	}
...
func TestCoreAPIResourcesExposeExpectedCommandSurface(t *testing.T) {
	expectedChildren := map[string][]string{
		...
		"edits templates":                    {"create", "get", "list", "update", "delete", "fill"},
		...
		"jobs":                               {"create", "retrieve", "wait", "cancel", "retry", "list"},
		"parses":                             {"create", "get", "list", "delete"},
		"partitions":                         {"create", "get", "list", "delete"},
		"schemas":                            {"generate"},
		"splits":                             {"create", "get", "list", "delete"},
		"workflows":                          {"list", "get", "create", "update", "delete", "publish", "diagnose", "view", "runs", "steps", "blocks", "edges", "artifacts", "reviews", "simulations", "tests", "experiments", "spec"},
		"workflows artifacts":                {"get", "list"},
		"workflows blocks":                   {"list", "get", "create", "update", "delete"},
		"workflows edges":                    {"list", "get", "create", "delete"},
		"workflows experiments":              {"create", "list", "get", "update", "delete", "runs"},
		"workflows experiments runs":         {"create", "list", "get", "cancel", "results", "metrics"},
		"workflows experiments runs metrics": {"get"},
		"workflows experiments runs results": {"list", "get"},
		...
		"workflows simulations":              {"create", "list"},
		"workflows spec":                     {"validate", "plan", "apply", "export"},
		"workflows steps":                    {"list", "get"},
		"workflows tests":                    {"create", "get", "list", "update", "delete", "runs"},
		"workflows tests runs":               {"create", "list", "get", "cancel", "results"},
		"workflows tests runs results":       {"list", "get"},
	}
