...
backup with ` + "`retab edits get`" + ` first if you may need it.
...
func init() {
	...
	editsCmd.AddCommand(editsCreateCmd, editsGetCmd, editsListCmd, editsDeleteCmd, editsCancelCmd, editsWaitCmd, editsTemplatesCmd)
