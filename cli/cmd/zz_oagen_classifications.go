...
func init() {
	...
	classificationsListCmd.Flags().String("status", "", "status filter")
	classificationsDeleteCmd.Flags().BoolP("yes", "y", false, "skip the confirmation prompt (required when stdin is not a TTY)")

	classificationsCmd.AddCommand(classificationsCreateCmd, classificationsGetCmd, classificationsListCmd, classificationsDeleteCmd, classificationsCancelCmd)
