...
var usagePrimitiveColumns = []TableColumn{
	...
	{Header: "CREATED_AT", Extract: func(row any) string { return usagePrimitiveCell(row, "created_at") }, IsTimestamp: true},
	{Header: "COMPLETED_AT", Extract: func(row any) string { return usagePrimitiveCell(row, "completed_at") }, IsTimestamp: true},
