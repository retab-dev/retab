//go:build retab_oagen_cli_prototype && retab_oagen_cli_workflows_tests
...
var allowedWorkflowTestRunStatuses = map[string]bool{"pending": true, "running": true, "completed": true, "error": true, "cancelled": true}
...
var workflowsTestsCreateCmd = &cobra.Command{
	...
	Example: "  retab workflows tests create wf_abc123 \\\n    --name \"Invoice 17 baseline\" \\\n    --target-file ./target.json \\\n    --source-file ./source.json \\\n    --assertion-file ./assertion.json",
	...
	RunE: runE(func(cmd *cobra.Command, args []string) error {
		...
		req := retab.WorkflowTestsCreateParams{WorkflowID: workflowID}
...
var workflowsTestsGetCmd = &cobra.Command{
	Use:   "get <test-id>",
	Short: "Get a test",
	Long:  "Fetch a test's definition: target block, source input, assertion output, name, timestamps.",
...
var workflowsTestsUpdateCmd = &cobra.Command{
	Use:   "update <test-id>",
	Short: "Update a test",
	Long:  "Re-pin a test's expected output or source input, or rename it.",
	Args:  cobra.ExactArgs(1),
	RunE: runE(func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	workflowsTestsCmd.AddCommand(workflowsTestsCreateCmd, workflowsTestsGetCmd, workflowsTestsListCmd, workflowsTestsUpdateCmd, workflowsTestsDeleteCmd)
