...
async function main() {
  ...
  // Create schema object with Zod model converted to JSON Schema
  ...
  const validatedData = CalendarEventSchema.parse(rawData);

  console.log('\n✅ Extracted Calendar Event (Zod validated):');
